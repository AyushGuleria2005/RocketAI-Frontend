...
const Preview = () => {
  ...
  // console.log(list);
  return (
    <div className="border-white border-2 rounded-2xl mt-2 px-3 pb-3 min-h-56 max-h-56 overflow-y-auto shadow-md hover:shadow-lg transition-all duration-200">
      <h1 className="text-xl mt-2 text-blue-600 font-medium text-center border-b border-red-500 pb-1">
        🚀 Sources Preview
      </h1>
